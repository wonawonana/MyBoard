...
public class Dialog_Owner_favorite extends androidx.fragment.app.DialogFragment implements View.OnClickListener {
    ...
    public Dialog_Owner_favorite(int i) {
        mI = i;
    }
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (document.exists()) {
                                            ...
                                            DocumentReference docRef=db.collection("cafe").document(MapView.mDataset_marker.get(mI).id);
                                            ...
                                            cafeDB cafe=new cafeDB(MapView.mDataset_marker.get(mI).place_name,0,
                                                    0, 0, 0, input, "", ""
                                                    ,MapView.mDataset_marker.get(mI).address_name,
