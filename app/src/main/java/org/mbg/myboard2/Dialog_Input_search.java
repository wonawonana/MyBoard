...
public class Dialog_Input_search extends androidx.fragment.app.DialogFragment implements View.OnClickListener {
    ...
    public Dialog_Input_search(BoardCafe mSearch_result_position){
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                DocumentReference docRef=db.collection("cafe").document(mSearch_result_position.id);
                                ...
                                cafeDB cafe=new cafeDB(mSearch_result_position.place_name,newClean,
                                        newGameNum, newService,1, new ArrayList<>(), "", ""
                                        ,mSearch_result_position.address_name,
