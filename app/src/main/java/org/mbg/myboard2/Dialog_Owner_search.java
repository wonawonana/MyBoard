...
public class Dialog_Owner_search extends androidx.fragment.app.DialogFragment implements View.OnClickListener {
    ...
    public Dialog_Owner_search(BoardCafe mSearch_result_position) {
